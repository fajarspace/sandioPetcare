<div class="list-group">
    ...
    <!--a href="administrator/setting/banner" class="list-group-item list-group-item-action">Banner Slider</a-->
    <!--a href="administrator/setting/description" class="list-group-item list-group-item-action">Deskripsi Singkat</a-->
    ...
    <a href="<?= base_url(); ?>administrator/setting/ongkir" class="list-group-item list-group-item-action">Ongkos Kirim</a>
    <a href="<?= base_url(); ?>administrator/setting/delivery" class="list-group-item list-group-item-action">Biaya Antar</a>
    <!--a href="administrator/setting/cod" class="list-group-item list-group-item-action">Cash On Delivery</a-->
